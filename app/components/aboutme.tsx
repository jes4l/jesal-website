export default function AboutMe({ dragListeners = {} }: { dragListeners?: any }) {
  return (
    <div className="w-lg bg-[#A7C7E7] border-2 border-[#304269] p-4 shadow-lg rounded-none crt-screen">
      <div 
      ...
      >
        {}
        <span className="crt-text-glow">About Me</span>
      </div>
      {}
      <p className="text-base font-mono -mt-2 crt-text-glow">
